...
largest_turnount_county = ""
winning_turnout_count = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        f"County Total Votes: {turnout:,}\n"
        f"County Percentage of Total Votes: {turnout_percentage: .1f}\n\n")
        print(county_turnout, end="")
        # 6e: Save the county votes to a text file.
        txt_file.write(county_turnout)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if turnout > winning_turnout_count:
            winning_turnout_count = turnout
            largest_turnount_county = county_name

    # 7: Print the county with the largest turnout to the terminal.
    print(f"\nLargest County Turnout: {largest_turnount_county}\n")

    # 8: Save the county with the largest turnout to a text file.
    #txt_file.write(largest_turnount_county)
